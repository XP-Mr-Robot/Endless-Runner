...
namespace VrGamesDev
{
    ...
    public class VRG_DataBase : VRG_Base
    {
        ...
        */
        ...
        public static string[] m_MusicGroups = { "Master", "Music", "SFx", "UI", "Ambience", "Voice" };
        ...
        public static string GetAudioMixerGroup(ENUM_AudioMixer valueLocal)
        {
            if (m_MusicGroups[(int)(valueLocal)] != null)
            {
                return m_MusicGroups[(int)(valueLocal)];
            }
            else
            {
                return m_MusicGroups[0];
            }
        }
        public static string GetAudioMixerGroup(int valueLocal)
        {
            if (m_MusicGroups[(int)(valueLocal)] != null)
            {
                return m_MusicGroups[(int)(valueLocal)];
