...
namespace VrGamesDev
{
    ...
    public class VRG_Base : MonoBehaviour
    {
        ...
        /// <summary>
        /// The remote data from the server or the VRG_Remote, this will delegate to any of the virtual functions:
        /// RemoteSettings_Default
        /// RemoteSettings_Cached
        /// RemoteSettings_Remote
        /// </summary>
        ...
        ///#IGNORE
        public virtual void OnOver() { WAS_FullName("Inside of OnOver() override the function in your class"); }
        ///#IGNORE
        public virtual void OnOut() { WAS_FullName("Inside of OnOut() override the function in your class"); }
        ///#IGNORE
        public virtual void OnClick() { WAS_FullName("Inside of OnClick() override the function in your class"); }
        ...
        protected Image Encuentra(Image valueLocal) => this.Encuentra(valueLocal, true);
        protected Image Encuentra(Image valueLocal, bool destroyLocal)
        {
        ...
        protected RectTransform Encuentra(RectTransform valueLocal) => this.Encuentra(valueLocal, true);
        protected RectTransform Encuentra(RectTransform valueLocal, bool destroyLocal)
        {
            string sObjectFinder = "";
        ...
        protected GridLayoutGroup Encuentra(GridLayoutGroup valueLocal) => this.Encuentra(valueLocal, true);
        protected GridLayoutGroup Encuentra(GridLayoutGroup valueLocal, bool destroyLocal)
        {
            string sObjectFinder = "";
        ...
        protected AudioSource Encuentra(AudioSource valueLocal) => this.Encuentra(valueLocal, true);
        protected AudioSource Encuentra(AudioSource valueLocal, bool destroyLocal)
        {
            string sObjectFinder = "";
        ...
        protected Text Encuentra(Text valueLocal) => this.Encuentra(valueLocal, true);
        protected Text Encuentra(Text valueLocal, bool destroyLocal)
        {
            string sObjectFinder = "";
