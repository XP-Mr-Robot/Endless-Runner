...
{
    public class VRG_CloneMe : VRG_Base
    {
        ...
        {
            print("OnEnable_IEnumerator");

            //this.m_PlayMakerFsm.GetComponent<PlayMakerFSM>().FsmVariables.GetFsmInt(child.key).Value = child.value;
            //this.m_PlayMakerFsm.SendEvent("VRG_Story.finish");
